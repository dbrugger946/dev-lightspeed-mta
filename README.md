...
- Alternatively, connecting to the postgres pod and drop all tables with psql, then bounce the pod  
  ...
  - *re-initialization (create new empty tables) doesn't seem to occur until after quiting and restarting VSCode, or more imortantly resetting the solution server connection from the MTA Analysis View*
